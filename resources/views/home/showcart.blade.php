...
<body>
    <div class="hero_area">
        ...
        <div class="center">
            ...
            <a href="{{url('cash_order')}}" class="btn btn-danger">Bayar di Lokasi</a>
            <a href="{{url('stripe',$totalprice)}}" class="btn btn-danger">Bayar Debit</a>
    ...
    <div class="cpy_">
        <p class="mx-auto">© 2022 All Rights Reserved By <a href="https://html.design/">POLINEMA</a><br>
            ...
            Distributed By <a href="https://ptindobismar.com/" target="_blank">Magang Polinema</a>
